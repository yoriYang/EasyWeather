...
public class main_pollutants_view extends View {
	private Paint paint;
	...
	public main_pollutants_view(Context context) {
		super(context);
	...
	public main_pollutants_view(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		this.paint = new Paint();
		this.paint.setAntiAlias(true); // 消除锯齿
	...
	public void onDraw(Canvas canvas) {
		...
		canvas.drawArc(oval, 145, (((float) pmNumber / 400) * 250), false,
				paint);

		Paint TextPaint = new Paint();
		TextPaint.setStyle(Paint.Style.FILL_AND_STROKE);
		TextPaint.setTextAlign(Paint.Align.CENTER);
		String pm25String = String.valueOf(pmNumber);
		switch (level) {
		case 1:
		...
		canvas.drawText("pm2.5指数", getWidth() / 2, getHeight() * 6 / 7,
				TextPaint);
